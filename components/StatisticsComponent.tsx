...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 18, fontWeight: 'bold', color: 'rgba(0,0,0,0.8)', marginBottom: 4, marginRight: 8 },
  visitedNumber: { fontSize: 24, fontWeight: 'bold', color: '#3bb2d0' },
  totalText: { fontSize: 18, color: 'rgba(0,0,0,0.6)', marginHorizontal: 2 },
  percentText: { fontSize: 12, color: 'rgba(0,0,0,0.6)', marginRight: 16, marginTop: 6 },
  wishlistText: { fontSize: 14, color: 'rgba(51,51,51,0.7)' },
  ...
  burgerIcon: { fontSize: 24, fontWeight: 'bold', color: 'rgba(0,0,0,0.7)' },
});
